  ...
  return (
      ...
      <p>
        * Any personal insurance you may have that covers damage to the host’s
        ...
        wallet. Liability insurance is provided under a policy issued to Turo by
      ...
      <p>
        ...
        and the licensed states listed here may contact Turo Insurance Agency at
        (415) 508-0283 or claims@turo.agency. For questions about how damage to
        a host’s vehicle is handled, visit the Turo Support site.
      </p>
      <p>
        When a trip is booked in the state of Washington, physical damage to the
        host’s vehicle is covered by insurance purchased by Turo, but the Turo
        insurance does not change the contractual responsibilities of hosts or
